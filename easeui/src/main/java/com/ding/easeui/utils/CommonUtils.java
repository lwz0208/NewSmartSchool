...
import com.ding.easeui.ui.EaseShowBigImageActivity;
...
//    }
    ...
    public static void getNickname(Context mCt, final String UserPhone,
        ...
        if (realname != null) {
            ...
            CommonUtils.setCommonJson(mCt, sent, com.ding.easeui.utils.PreferenceManager.getInstance().getCurrentUserFlowSId());
    ...
    public static void setCommonJson(Context context, JSONObject commonJson, String sid) throws JSONException {
        ...
        commonJson.put("loginId", com.ding.easeui.utils.PreferenceManager.getInstance().getCurrentUserId());
