...
import com.ding.easeui.widget.EaseChatPrimaryMenuBase;
...
import com.ding.easeui.controller.EaseUI;
import com.ding.easeui.domain.EaseEmojicon;
import com.ding.easeui.domain.Notice_data;
import com.ding.easeui.domain.UserInfoEntity;
import com.ding.easeui.utils.ACache;
import com.ding.easeui.widget.EaseAlertDialog;
import com.ding.easeui.widget.EaseAlertDialog.AlertDialogUser;
import com.ding.easeui.widget.EaseChatExtendMenu;
import com.ding.easeui.widget.EaseChatInputMenu;
import com.ding.easeui.widget.EaseChatInputMenu.ChatInputMenuListener;
import com.ding.easeui.widget.EaseChatMessageList;
import com.ding.easeui.widget.EaseVoiceRecorderView;
import com.ding.easeui.widget.EaseVoiceRecorderView.EaseVoiceRecorderCallback;
...
public class EaseChatFragment extends EaseBaseFragment {
    protected static final String TAG = "EaseChatFragment_DeBugs";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Key_RealName = toChatUsername + "_realname";
        // 自己的username，因为请求群公告需要用
        myUsername = EMClient.getInstance().getCurrentUser();
        ...
        OkHttpUtils.postString().url(Constant.USERINFO_URL)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call arg0, Exception arg1) {
                        Log.i("ChatActivity", arg0 + "---" + arg1.toString());
    ...
    protected void initView() {
        ...
        inputMenu.setChatInputMenuListener(new
    ...
    private void getGroupNotice() throws JSONException {
        ...
        OkHttpUtils.postString().url(Constant.GETGROUPNOTICE_URL)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String arg0) {
                        ...
                        try {
                            ...
                            if (jObject.getInt("code") == 1
                                    ...
                                    && jObject.getJSONObject("data").getInt(
                                    "status") == 0) {
                                ...
                                if (getContext() != null) {
                                    ...
                                    new android.app.AlertDialog.Builder(getContext()).setTitle("公告("
                                            + data.getUpdateTime()
                                            + ")")
                                            .setMessage(data.getContent())
                                            .setCancelable(true)
                                            .setPositiveButton("确定收到",
                    ...
                    @Override
                    public void onError(Call arg0, Exception arg1) {
//                        Toast.makeText(getActivity(), "获取群公告失败", Toast.LENGTH_SHORT).show();
                    }
                });

    }

    private void ReadFlag(String noticeid) {
        ...
        OkHttpUtils.postString().url(Constant.CHECKGROUPNOTICEREAD_URL)
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            if (mCache.getAsString(Key_RealName) == null) {
                try {
                    getUserRealName(toChatUsername);
                ...
                Log.i("toChatUsername", mCache.getAsString(Key_RealName));
                titleBar.setTitle(mCache.getAsString(Key_RealName));
            }
    ...
    protected void onChatRoomViewCreation() {
        final ProgressDialog pd = ProgressDialog.show(getActivity(), "",
                "Joining......");
        EMClient.getInstance().chatroomManager()
                .joinChatRoom(toChatUsername, new EMValueCallBack<EMChatRoom>() {
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (getActivity().isFinishing()
                                        || !toChatUsername.equals(value.getId()))
                                    return;
                                pd.dismiss();
     ...
     * @param uri
     */
    protected void sendFileByUri(Context context, Uri uri) {
...
//        }
        String filePath = CommonUtils.FileUtilsgetPathUp4p4(context, uri);
        File file = new File(filePath);
        if (file == null || !file.exists()) {
            Toast.makeText(getActivity(), R.string.File_does_not_exist, Toast.LENGTH_SHORT)
                    .show();
            return;
        }
        // 大于10M不让发送
