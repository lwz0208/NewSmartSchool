...
import com.ding.easeui.adapter.EaseContactAdapter;
...
public class EaseContactList extends RelativeLayout
{
	...
	private void init(Context context, AttributeSet attrs)
	{
		...
		LayoutInflater.from(context).inflate(R.layout.ease_widget_contact_list,
				this);
	...
	public void init(List<EaseUser> contactList)
	{
		...
		adapter = new EaseContactAdapter(context, 0, new ArrayList<EaseUser>(
				contactList));
