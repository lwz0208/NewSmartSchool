...
import com.ding.easeui.model.EaseVoiceRecorder;
import com.ding.easeui.utils.EaseCommonUtils;
import com.ding.easeui.widget.chatrow.EaseChatRowVoicePlayClickListener;
...
public class EaseVoiceRecorderView extends RelativeLayout
{
	...
	private void init(Context context)
	{
		...
		LayoutInflater.from(context).inflate(
				R.layout.ease_widget_voice_recorder, this);
			...
			EaseVoiceRecorderCallback recorderCallback)
	{
		...
		case MotionEvent.ACTION_DOWN:
			try
			{
				if (EaseChatRowVoicePlayClickListener.isPlaying)
					EaseChatRowVoicePlayClickListener.currentPlayListener
							.stopPlayVoice();
				v.setPressed(true);
				startRecording();
			} catch (Exception e)
		...
		case MotionEvent.ACTION_UP:
			...
			} else
			{
				...
				{
					e.printStackTrace();
					Toast.makeText(context, R.string.send_failure_please,
							Toast.LENGTH_SHORT).show();
				}
			}
			return true;
	...
	public void startRecording()
	{
		...
		{
			Toast.makeText(context, R.string.Send_voice_need_sdcard_support,
					Toast.LENGTH_SHORT).show();
			return;
		}
		try
		{
			...
			recordingHint
					.setText(context.getString(R.string.move_up_to_cancel));
		...
		} catch (Exception e)
		{
			...
			Toast.makeText(context, R.string.recoding_fail, Toast.LENGTH_SHORT)
					.show();
			return;
		}
	}
	...
	public void showReleaseToCancelHint()
	{
		...
		recordingHint
				.setBackgroundResource(R.drawable.ease_recording_text_hint_bg);
	}
