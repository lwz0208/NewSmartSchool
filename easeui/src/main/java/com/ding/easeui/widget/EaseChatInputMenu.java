package com.ding.easeui.widget;
...
import com.ding.easeui.utils.EaseSmileUtils;
import com.ding.easeui.R;
import com.ding.easeui.domain.EaseEmojicon;
import com.ding.easeui.domain.EaseEmojiconGroupEntity;
import com.ding.easeui.model.EaseDefaultEmojiconDatas;
import com.ding.easeui.widget.EaseChatExtendMenu.EaseChatExtendMenuItemClickListener;
import com.ding.easeui.widget.EaseChatPrimaryMenuBase.EaseChatPrimaryMenuListener;
import com.ding.easeui.widget.emojicon.EaseEmojiconMenu;
import com.ding.easeui.widget.emojicon.EaseEmojiconMenuBase;
import com.ding.easeui.widget.emojicon.EaseEmojiconMenuBase.EaseEmojiconMenuListener;
...
public class EaseChatInputMenu extends LinearLayout {
    ...
    //返回Edittext的实例。
    public View getChatPrimaryMenuView() {
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (chatPrimaryMenu == null) {
            chatPrimaryMenu = (EaseChatPrimaryMenu) layoutInflater.inflate(
                    R.layout.ease_layout_chat_primary_menu, null);
        }
    ...
    public void registerExtendMenuItem(String name, int drawableRes,
                                       int itemId, EaseChatExtendMenuItemClickListener listener) {
    ...
    protected void processChatMenu() {
        // 发送消息栏
        chatPrimaryMenu
                .setChatPrimaryMenuListener(new EaseChatPrimaryMenuListener() {
            ...
            public void onExpressionClicked(EaseEmojicon emojicon) {
                if (emojicon.getType() != EaseEmojicon.Type.BIG_EXPRESSION) {
                    if (emojicon.getEmojiText() != null) {
                        chatPrimaryMenu.onEmojiconInputEvent(EaseSmileUtils
                                .getSmiledText(context, emojicon.getEmojiText()));
                    }
                } else {
                    if (listener != null) {
