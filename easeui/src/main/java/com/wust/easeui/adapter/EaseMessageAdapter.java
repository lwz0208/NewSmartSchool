...
import com.wust.easeui.widget.chatrow.EaseChatRowBigExpression;
import com.wust.easeui.widget.chatrow.EaseChatRowFile;
import com.wust.easeui.widget.chatrow.EaseChatRowImage;
import com.wust.easeui.widget.chatrow.EaseChatRowLocation;
import com.wust.easeui.widget.chatrow.EaseChatRowText;
import com.wust.easeui.widget.chatrow.EaseChatRowVideo;
import com.wust.easeui.widget.chatrow.EaseChatRowVoice;
import com.wust.easeui.widget.chatrow.EaseCustomChatRowProvider;
import com.wust.easeui.widget.chatrow.MyChatRowLittleCard;
import com.hyphenate.chat.EMClient;
import com.hyphenate.chat.EMConversation;
import com.hyphenate.chat.EMMessage;
import com.wust.easeui.widget.chatrow.EaseChatRow;
    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message,
        ...
        switch (message.getType()) {
            case TXT:
                if (message.getBooleanAttribute(
                        EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    chatRow = new EaseChatRowBigExpression(context, message,
                            position, this);
                } else if (message.getBooleanAttribute(
                        "islittlecard", false)) {
                    chatRow = new MyChatRowLittleCard(context, message, position, this);
                } else {
