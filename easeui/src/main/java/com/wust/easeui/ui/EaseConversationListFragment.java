...
import com.wust.easeui.widget.EaseConversationList;
...
public class EaseConversationListFragment extends EaseBaseFragment {
    ...
    protected void initView() {
        ...
        // 第三方应用下拉列表
        //由于该方案撤销，故gone掉
        exListView = (ExpandableListView) getView().findViewById(
                R.id.exlistview);
    }
                    ...
                    .setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent,
                            ...
                            EMConversation conversation = conversationListView
                                    .getItem(position);
                            Log.i("conversationTAG", conversation.getUserName());
    ...
    //有时候获取不到群组的信息，导致群组头像显示的个数与实际不一致
    @Override
