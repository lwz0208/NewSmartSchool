...
import com.wust.newsmartschool.adapter.Prolistview_Adapter;
...
public class ProfessionalActivity extends BaseActivity {
    ...
    private Prolistview_Adapter colleagelistview_adapter;
    // 搜索的框框的控件
    private EditText query;
    private ImageButton clearSearch;
    List<CompanyEntity.DataBean.SubListBean> data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = new ArrayList<>();
        data = (List<CompanyEntity.DataBean.SubListBean>) getIntent().getSerializableExtra("professional");
        // 搜索框
        ...
        colleagelistview_adapter = new Prolistview_Adapter(this, data);
        ...
        colleagelistview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //点击事件
                startActivity(new Intent(ProfessionalActivity.this, GradeActivity.class).putExtra("grade", (Serializable) data.get(position).getSubList()).putExtra("title", data.get(position).getName()));
            }
        });
