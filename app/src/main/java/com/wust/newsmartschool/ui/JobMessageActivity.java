...
import com.wust.newsmartschool.adapter.JobAdapter;
...
public class JobMessageActivity extends Activity implements MyListView.IXListViewListener {
    ...
    private void getNewsList(final int pagenum) {
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                String urlString = "http://202.114.242.198:8090/EmploymentAnnounce.php?pagenum="
                        + pagenum;
