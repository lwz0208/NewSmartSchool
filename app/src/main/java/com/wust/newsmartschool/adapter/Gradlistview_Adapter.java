...
public class Gradlistview_Adapter extends BaseAdapter {
    private LayoutInflater mInflater;
    List<CompanyEntity.DataBean.SubListBean.SubListBean2> itemlist;
    private ViewHolder vh = new ViewHolder();

    public Gradlistview_Adapter(Context con, List<CompanyEntity.DataBean.SubListBean.SubListBean2> objects) {
