...
import com.wust.newsmartschool.adapter.MyTableAdapter;
import com.wust.newsmartschool.adapter.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
    ...
    public TableFixHeaders(Context context, AttributeSet attrs) {
        ...
        this.shadows[0].setImageResource(R.drawable.calendar_shadow_left);
        this.shadows[1] = new ImageView(context);
        this.shadows[1].setImageResource(R.drawable.calendar_shadow_top);
        this.shadows[2] = new ImageView(context);
        this.shadows[2].setImageResource(R.drawable.calendar_shadow_right);
        this.shadows[3] = new ImageView(context);
        this.shadows[3].setImageResource(R.drawable.calendar_shadow_bottom);
    ...
    public MyTableAdapter getAdapter() {
        return adapter;
    }

    public void setAdapter(MyTableAdapter adapter) {

        this.adapter = adapter;

        this.recycler = new MyRecycler(adapter.getViewTypeCount());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (adapter != null) {
            ...
            for (int i = -1; i < rowCount; i++) {
                heights[i + 1] = tableHeight / (rowCount + 4);
            }
