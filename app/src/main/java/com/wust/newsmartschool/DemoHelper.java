...
import com.wust.newsmartschool.domain.EmojiconExampleGroupData;
import com.wust.newsmartschool.domain.InviteMessage;
import com.wust.newsmartschool.domain.RobotUser;
import com.wust.newsmartschool.domain.InviteMessage.InviteMesageStatus;
import com.wust.newsmartschool.parse.UserProfileManager;
import com.wust.newsmartschool.receiver.CallReceiver;
import com.wust.newsmartschool.ui.ChatActivity;
import com.wust.newsmartschool.ui.MainActivity;
import com.wust.newsmartschool.ui.VideoCallActivity;
import com.wust.newsmartschool.ui.VoiceCallActivity;
import com.wust.easeui.utils.PreferenceManager;
import com.wust.easeui.Constant;
import com.wust.easeui.controller.EaseUI;
import com.wust.easeui.controller.EaseUI.EaseEmojiconInfoProvider;
import com.wust.easeui.controller.EaseUI.EaseSettingsProvider;
import com.wust.easeui.controller.EaseUI.EaseUserProfileProvider;
import com.wust.easeui.domain.EaseEmojicon;
import com.wust.easeui.domain.EaseEmojiconGroupEntity;
import com.wust.easeui.domain.EaseUser;
import com.wust.easeui.model.EaseNotifier;
import com.wust.easeui.model.EaseNotifier.EaseNotificationInfoProvider;
...
public class DemoHelper {
    ...
    protected static final String TAG = "DemoHelper_Debugs";
        ...
        easeUI.getNotifier().setNotificationInfoProvider(
                new EaseNotificationInfoProvider() {
                    ...
                    public String getDisplayedText(EMMessage message) {
                        ...
                        if (message.getStringAttribute(
                                "sendrealname", null) != null) {
                            return message.getStringAttribute(
                                    "sendrealname", null) + ": " + ticker;
                        } else {
                            if (DemoApplication.getInstance().mCache.getAsString(message.getFrom() + "_realname") != null) {
                                return DemoApplication.getInstance().mCache.getAsString(username + "_realname") + ": " + ticker;
                            } else {
     ...
     */
    //当前APP在后台的时候的监听新消息的函数，这个地方需要改变状态unread一下。
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    Log.e(TAG, "onMessageReceived id : " + message.getMsgId());
