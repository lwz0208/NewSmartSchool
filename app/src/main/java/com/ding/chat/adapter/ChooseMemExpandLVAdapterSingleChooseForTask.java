...
public class ChooseMemExpandLVAdapterSingleChooseForTask extends BaseExpandableListAdapter {
    ...
    public ChooseMemExpandLVAdapterSingleChooseForTask(Context context, List<GroupItem> dataList, ExpandableListView expandableList) {
    ...
    public View getChildView(final int groupPosition, int childPosition,
        ...
        viewHolder.childrenCB.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                ChooseMemExpandLVAdapterSingleChooseForTask.this.notifyDataSetChanged();
            }
        });
        if (checkedChildrenList.contains(mchildren)) {
