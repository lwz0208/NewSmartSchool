...
import com.ding.chat.adapter.ChooseMemExpandLVAdapterSingleChoose;
import com.ding.chat.adapter.ChooseMemExpandLVAdapterSingleChooseForTask;
import com.ding.chat.domain.ALLdepartmentId1;
import com.ding.chat.domain.ALLjobClassifyId2;
import com.ding.chat.domain.ALLpartyBranchId3;
import com.ding.chat.domain.ALLpositionalTitleId4;
import com.ding.chat.domain.ChildrenItem;
import com.ding.chat.domain.Common_TypeMem;
...
public class NoticeChooseMemActivitySingleChooseForTask extends BaseActivity {

    String TAG = "NoticeChooseMemActivitySingleChoose";
    private ExpandableListView expandableList;
    private ChooseMemExpandLVAdapterSingleChooseForTask adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ECProgressDialog(NoticeChooseMemActivitySingleChooseForTask.this);
        progressDialog.setPressText("拉取数据...");
        progressDialog.show();
        View contentView = LayoutInflater.from(NoticeChooseMemActivitySingleChooseForTask.this).inflate(
        ...
        adapter = new ChooseMemExpandLVAdapterSingleChooseForTask(NoticeChooseMemActivitySingleChooseForTask.this, dataList, expandableList);
...
//判断缓存是否存在树形结构，并且显示之
    ...
    private void getChildData(String reCallType, String groupId, final int groupPosition) throws JSONException {
        ...
        CommonUtils.setCommonJson(NoticeChooseMemActivitySingleChooseForTask.this, getChildDataJson, PreferenceManager.getInstance().getCurrentUserFlowSId());
    ...
    private void getAllMembersTypeDept() throws JSONException {
        ...
        CommonUtils.setCommonJson(NoticeChooseMemActivitySingleChooseForTask.this, DeptArchJson, PreferenceManager.getInstance().getCurrentUserFlowSId());
